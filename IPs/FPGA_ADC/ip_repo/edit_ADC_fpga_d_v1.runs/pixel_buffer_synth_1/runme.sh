...
HD_PWD='d:/alienware/course/ece532/milestone7/ips/fpga_adc/ip_repo/edit_ADC_fpga_d_v1.runs/pixel_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_buffer.tcl
