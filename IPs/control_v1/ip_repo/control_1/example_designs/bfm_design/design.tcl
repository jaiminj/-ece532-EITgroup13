...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/control_v1_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef control_v1_tb_include_vh_"
	puts $fp "`define control_v1_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:control:1]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/control_v1_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "control_v1_bfm_${i}"
...
remove_files -quiet -fileset sim_1 control_v1_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top control_v1_tb [get_filesets sim_1]
