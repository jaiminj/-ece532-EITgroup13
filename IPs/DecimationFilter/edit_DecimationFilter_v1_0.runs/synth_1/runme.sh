...
HD_PWD='c:/users/jaimin/xilinxprojects/mengproject/ips/decimationfilter/edit_DecimationFilter_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DecimationFilter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DecimationFilter_v1_0.tcl
