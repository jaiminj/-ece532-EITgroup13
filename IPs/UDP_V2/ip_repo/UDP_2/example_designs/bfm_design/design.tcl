...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/UDP_v2_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef UDP_v2_tb_include_vh_"
	puts $fp "`define UDP_v2_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:UDP:2]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/UDP_v2_tb.sv
...
remove_files -quiet -fileset sim_1 UDP_v2_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top UDP_v2_tb [get_filesets sim_1]
