...
HD_PWD='c:/users/jaimin/xilinxprojects/mengproject/ips/phasedetector/edit_phasedetector_v1_0.tmp/filteriir_v1_0_project/FilterIIR_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FilterIIR_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FilterIIR_v1_0.tcl
