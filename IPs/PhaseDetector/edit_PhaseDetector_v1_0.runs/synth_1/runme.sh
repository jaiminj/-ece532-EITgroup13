...
HD_PWD='c:/users/jaimin/xilinxprojects/mengproject/ips/phasedetector/edit_PhaseDetector_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PhaseDetector_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PhaseDetector_v1_0.tcl
