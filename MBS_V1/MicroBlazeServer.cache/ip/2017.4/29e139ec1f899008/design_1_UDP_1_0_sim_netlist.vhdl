...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UDP_v1_0_S00_AXI is
  ...
  signal \counter0[1]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \addr[2]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \addr[5]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \addr[6]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \axi_araddr[3]_i_1\ : label is "soft_lutpair44";
  ...
  attribute SOFT_HLUTNM of clk_1MHz_i_1 : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \counter0[1]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \counter0[2]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \counter0[3]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \counter0[4]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \counter0[5]_i_1\ : label is "soft_lutpair43";
...
\addr[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
clk_1MHz_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB04"
    )
        port map (
...
\counter0[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"38"
        ...
        port map (
      I0 => \counter0[1]_i_2_n_0\,
      I1 => \counter0_reg_n_0_[0]\,
      I2 => \counter0_reg_n_0_[1]\,
      O => \counter0[1]_i_1_n_0\
    );
\counter0[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF7"
    )
        port map (
      I0 => \counter0_reg_n_0_[5]\,
      I1 => \counter0_reg_n_0_[4]\,
      I2 => \counter0_reg_n_0_[2]\,
      I3 => \counter0_reg_n_0_[3]\,
      I4 => \counter0_reg_n_0_[6]\,
      O => \counter0[1]_i_2_n_0\
    );
...
\counter0[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
      I0 => \counter0_reg_n_0_[2]\,
      I1 => \counter0_reg_n_0_[0]\,
      I2 => \counter0_reg_n_0_[1]\,
      I3 => \counter0_reg_n_0_[3]\,
...
\counter0[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \counter0[6]_i_2_n_0\,
      I3 => \counter0_reg_n_0_[4]\,
      I4 => \counter0[5]_i_2_n_0\,
      O => \counter0[4]_i_1_n_0\
    );
\counter0[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F252"
    )
        port map (
      I0 => \counter0_reg_n_0_[4]\,
      I1 => \counter0[6]_i_2_n_0\,
      I2 => \counter0_reg_n_0_[5]\,
      I3 => \counter0[5]_i_2_n_0\,
...
\counter0[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \counter0[6]_i_2_n_0\,
      I3 => \counter0_reg_n_0_[6]\,
      O => \counter0[6]_i_1_n_0\
    );
\counter0[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
