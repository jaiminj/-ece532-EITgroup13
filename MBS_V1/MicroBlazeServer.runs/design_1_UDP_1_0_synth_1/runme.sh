...
HD_PWD='D:/AlienWare/Course/ECE532/MileStone5/MileStone5/MBS_V1/MicroBlazeServer.runs/design_1_UDP_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_UDP_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_UDP_1_0.tcl
